...
const Testimonial = () => {
  return (
    <div className="h-auto flex flex-col items-center justify-center w-full" id="home">
          ...
          <div className="h-auto px-4 mx-auto max-w-7xl lg:px-8">
            <div className="h-auto flex flex-col items-center">
              <div className="text-center">
                <h2 className="text-3xl p-5 pb-10 font-bold text-gray-900 sm:text-4xl xl:text-5xl">What clients say about us</h2>
              </div>
              <div className="relative mt-2 md:order-2">
                <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                  <div className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter shadow-md" style={{ background: '' }}></div>
                </div>
                <Slider {...settings} className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-1">
                  {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="flex flex-col overflow-hidden shadow-md">
                      <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                        <div className="flex-1">
                          ...
                          <blockquote className="flex-1 mt-8">
                            <p className="md:text-lg text-sm leading-relaxed text-gray-900">{testimonial.text}</p>
                          </blockquote>
                        </div>

                        <div className="flex items-center mt-8">
                          <div className="ml-4 w-full items-center flex flex-col justify-center">
                          <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src={testimonial.avatar} alt={testimonial.author} />
