...
const menu = [
  {
    id: 1,
    image: 'https://images.unsplash.com/photo-1534778101976-62847782c213?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    title: 'Cappuccino',
  ...
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1485808191679-5f86510681a2?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    title: 'Espresso',
  ...
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1530373239216-42518e6b4063?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    title: 'Mocha',
...
const dessert = [
  {
    id: 5,
    image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGJyb3duJTIwY29va2llfGVufDB8fDB8fHww',
    title: 'Brown Cookie',
  ...
  {
    id: 6,
    image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?q=80&w=1528&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    title: 'Caramel',
  ...
  {
    id: 7,
    image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2hvY29sYXRlJTIwY2FrZXxlbnwwfHwwfHx8MA%3D%3D',
  ...
  {
    id: 8,
    image: 'https://images.unsplash.com/photo-1543512601-f0b56be2147e?q=80&w=1368&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    title: 'Doughnut',
  ...
  return (
    <div className="min-h-screen h-auto flex flex-row items-center justify-center text-black" id='menu'>
      <div className='md:h-[90%] md:w-[90%] w-full bg-background rounded-md flex flex-col p-4'>
                ...
                <div className='flex flex-col items-start bg-white rounded-md'>
                  <div className='relative h-[250px] w-full'>
                    ...
                    <img
                      src={coffee.image}
                      alt={coffee.title}
                      className={`object-cover rounded-t-md h-full w-full ${!imageLoaded[coffee.id] ? 'hidden' : 'block'}`}
                  ...
                  <div className='flex flex-col items-start w-full'>
                    ...
                    <span className='text-gray-700 mb-2 text-sm'>{coffee.description}</span>
        ...
        <div className=' h-auto w-full flex flex-col items-center justify-center p-3'>
          <h1 className="active text-dark-brown text-xl font-bold mt-10">Dessert Service</h1>
                ...
                <div className='flex flex-col items-start bg-white rounded-md'>
                  <div className='relative h-[250px] w-full'>
                    ...
                    <img
                      src={dessert.image}
                      alt={dessert.title}
                      className={`object-cover rounded-t-md h-full w-full ${!imageLoaded[dessert.id] ? 'hidden' : 'block'}`}
                  ...
                  <div className='flex flex-col items-start w-full'>
                    ...
                    <span className='text-gray-700 mb-2 text-sm'>{dessert.description}</span>
                    <div className='flex flex-row justify-between items-center w-full'>
